...
class marlSAC(object):
    ...
    def __init__(
        ...
        save_directory=Path("robot_nav/models/MARL/marlSAC/checkpoint"),
        model_name="marlSAC",
        load_model_name=None,
        load_directory=Path("robot_nav/models/MARL/marlSAC/checkpoint"),
    ):
        super().__init__()
    ...
    def act(self, obs, sample=False):
        ...
        obs = obs.unsqueeze(0)
        dist, connection, _, _, _, combined_weights = self.actor(obs)
